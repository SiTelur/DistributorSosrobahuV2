    ...
    <div class="container">
        <div class="header">
            ...
            <div class="right">
                ...
                <div>{{ $notaDistributor['tanggal'] }}</div>
                <div>INVO/SOSRO/00{{ $notaDistributor['id_order'] }}</div>
        ...
        <div class="info">
            ...
            <div>{{ $notaDistributor['nama_distributor'] }}</div>
            <div>{{ $notaDistributor['no_telp'] }}</div>
        </div>
        ...
        <div class="note">
            Terima kasih atas kepercayaan Anda kepada kami, <strong>Distributor Resmi Sosrobahu</strong>.<br>
            Untuk bantuan atau informasi lebih lanjut, silakan hubungi Admin Official <strong>CV. Santoso Jaya Tembakau</strong> melalui WhatsApp di {{ $notaDistributor['no_pabrik'] }}.
        </div>
    </div>
</body>
</html>
